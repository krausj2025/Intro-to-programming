...
def wrong_add_function(arg1,arg2):
    ...
    print(f'\nExpected correct answer should be: {[x + sum(arg2) for x in arg1]}')
    arg1_index=0
    while arg1_index < len(arg1):
        arg_2_sum = 0
        print(f'\nLoop iteration {arg1_index}: starting with arg1[{arg1_index}] = {arg1[arg1_index]}')
        for arg2_elements in arg2:
            print(f' Adding each element of arg2... currently arg2_elements = {arg2_elements}')
            arg_2_sum = sum([arg1[arg1_index]+i for i in arg2])
            print(f' Inside loop -> arg_2_sum = {arg_2_sum}')
            arg1[arg1_index]=arg_2_sum  
            arg1_index+=1  
            print(f' Incremented arg1_index -> now {arg1_index}')
            return arg1  
...
def correct_add_function(arg1,arg2):
    print(f'\nThe correct answer should be: {[x + sum(arg2) for x in arg1]}')
    arg1_index=0
    while arg1_index < len(arg1):
...
def exception_add_function(arg1,arg2):
    try:
        ...
        return result
    except TypeError as e:  #If we hit a TypeError, inspect which element caused the error
        for index, value in enumerate(arg1):
            if not isinstance(value, (int, str)):
                print(f'Your input argument 1 at element {index} '
                        f'is not of the expected type. Please change this and rerun.')
                return
        for index, value in enumerate(arg2):
            if not isinstance(value, (int, str)):
                print(f'Your input argument 2 at element {index} '
                        f'is not of the expected type. Please change this and rerun.')
                return  #if the error is not about invalid types
...
def correction_add_function(arg1, arg2):
    try:
        ...
        #if a TypeError occurs (mixed types), attempt automatic correction
        print('Detected mixed or invalid input types - attempting automatic correction.')
        arg1_fixed = [str(x) for x in arg1]
        arg2_fixed = [str(x) for x in arg2]
        return wrong_add_function(arg1_fixed, arg2_fixed)
